...
void init_ops(nb::module_& m) {
  ...
  m.def(
      ...
      "use_mmap"_a = false,
      nb::sig(
          "def load(file: Union[file, str, pathlib.Path], /, format: Optional[str] = None, return_metadata: bool = False, *, stream: Union[None, Stream, Device] = None, use_mmap: bool = False) -> Union[array, dict[str, array], Tuple[dict[str, array], dict[str, Any]]]"),
      R"pbdoc(
        ...
        Args:
            ...
            use_mmap (bool, optional): If ``True``, use memory-mapped I/O to
              load safetensors files for zero-copy weight loading. Only
              supported for file paths (not file objects) on non-Windows
