...
def load_model(
    ...
    Args:
        ...
        use_mmap (bool): If ``True``, use memory-mapped I/O for zero-copy
            weight loading. Default: ``False``
...
def load(
    ...
    model, config = load_model(model_path, lazy, model_config=model_config, use_mmap=use_mmap)
